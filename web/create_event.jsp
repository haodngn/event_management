...
<!--        <form method="get" action="MainController">
        <table  align="center" cellpadding = "15" style="margin-bottom: 3rem">
            ...
            <tr>
                <td>Speaker</td>
                <td><input type="text" name="txtSpeaker" maxlength="50" placeholder="Speaker..." required="" />
            ...
            <tr>
                <td>Event's Name</td>
                <td><input type="text" name="txtEventName" maxlength="50" placeholder="Event's name..." required="" />
            ...
            <tr>
                <td>Occur Date</td>
                <td>
                    <select name="txtOccurDate" id="Birthday_Day" required="">
                    ...
                    <select id="Birthday_Month" name="txtEndDate">
                        <option value="-1"> </option>
            ...
            <tr>
                ...
                <td>
                    ...
                    <textarea name="Address" rows="2" cols="60" required="" placeholder="Short description..."></textarea>
                </td>
            </tr>
            ...
            <tr >
                ...
                <td><textarea name="Address" rows="2" cols="60" placeholder="Location" required="" ></textarea></td>
            </tr>
            ...
            <div class="login-box">
                ...
                <input
                     style="font-size: 20px; background-color: #f60;" type="submit" required="" name="btnAction" value="Create"  />
